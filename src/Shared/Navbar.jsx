...
const Navbar = () => {
    ...
    const navItem = <>
        ...
        <li><ActiveLink to='/allprojects'>All Projects</ActiveLink></li>
    ...
    useEffect(() => {
        const setthemecolor = document.querySelector('html');
        setthemecolor.setAttribute('data-theme', theme)
    }, [theme])
    return (
        <Container>
            <div className="navbar bg-base-100">
                <div className="navbar-start">
                    ...
                    <Link to='/' className="text-xl font-bold uppercase">msui.</Link>
                </div>
